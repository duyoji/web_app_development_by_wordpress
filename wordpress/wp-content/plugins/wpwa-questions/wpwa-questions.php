...
function wpwa_frontend_scripts() {
    ...
    wp_enqueue_script( 'wp-questions', plugins_url( 'js/questions.js', __FILE__ ), [], false, true );
    wp_enqueue_style( 'questions' );
    wp_enqueue_style( 'questions', plugins_url( 'css/questions.css', __FILE__ ), [], false, 'all' );
